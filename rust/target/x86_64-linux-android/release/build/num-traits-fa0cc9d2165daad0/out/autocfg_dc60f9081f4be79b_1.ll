; ModuleID = 'autocfg_dc60f9081f4be79b_1.8ea2c1c927889985-cgu.0'
source_filename = "autocfg_dc60f9081f4be79b_1.8ea2c1c927889985-cgu.0"
...
define internal i8 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$9total_cmp17hfec0d923712da78eE"(ptr align 8 %self, ptr align 8 %other) unnamed_addr #0 {
start:
...
; autocfg_dc60f9081f4be79b_1::probe
; Function Attrs: nonlazybind uwtable
define void @_ZN26autocfg_dc60f9081f4be79b_15probe17h321d2298d9730139E() unnamed_addr #1 {
start:
; call core::f64::<impl f64>::total_cmp
  %_1 = call i8 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$9total_cmp17hfec0d923712da78eE"(ptr align 8 @alloc_f93507f8ba4b5780b14b2c2584609be0, ptr align 8 @alloc_ef0a1f828f3393ef691f2705e817091c)
  ret void
}

attributes #0 = { inlinehint nonlazybind uwtable "probe-stack"="inline-asm" "target-cpu"="x86-64" "target-features"="+mmx,+sse,+sse2,+sse3,+ssse3,+sse4.1,+sse4.2,+popcnt" }
attributes #1 = { nonlazybind uwtable "probe-stack"="inline-asm" "target-cpu"="x86-64" "target-features"="+mmx,+sse,+sse2,+sse3,+ssse3,+sse4.1,+sse4.2,+popcnt" }
